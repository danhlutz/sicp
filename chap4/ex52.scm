(define version "amb 0.1.2")
(define description "AMB evaluator with PERMANENT-SET!. Based on meta-0.3.scm")
...
(define (analyze exp)
  (cond ((self-evaluating? exp) (analyze-self-evaluating exp))
        ...
        ((permanent-set? exp) (analyze-perm-assignment exp))
...
;; when I used SET! instead of PERMANENT-SET!
;; the program iterates thru all the different distinct combinations 
;; of X and Y, but the count each time is reset to 1
