...
(define (unless->if exp)
  (make-if (unless-condition exp)
           (list (make-lambda '() (unless-usual exp)))
           (list (make-lambda '() (unless-exception exp)))))

;; above I am trying to delay the evaluation of the usual and exceptional
;; values, but I'm still getting a recursion error in my Lisp 
;; interpreter because it is still using applicative order
