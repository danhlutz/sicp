...
; explanation. This works because apply-generic is used to successively 
; strip off the type-tags to get to the correct procedure. 
...
; --> (let ((proc (get op type-tags))))
; --> (let ((proc (get 'magntitude '(complex)))))
; --> (let ((proc magnitude)))
