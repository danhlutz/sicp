(define version "0.2.x")
(define description "Define a new syntax")
...
(define (operation-exp? exp operations)
  (assoc (car exp) operations))

(define (operation-exp-op operation-expression)
  (car operation-expression))
